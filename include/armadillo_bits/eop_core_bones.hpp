...
class eop_log               : public eop_core<eop_log>               , public eop_use_mp_false {};
class eop_log2              : public eop_core<eop_log2>              , public eop_use_mp_false {};
class eop_log10             : public eop_core<eop_log10>             , public eop_use_mp_false {};
class eop_trunc_log         : public eop_core<eop_trunc_log>         , public eop_use_mp_false {};
class eop_exp               : public eop_core<eop_exp>               , public eop_use_mp_false {};
class eop_exp2              : public eop_core<eop_exp2>              , public eop_use_mp_false {};
class eop_exp10             : public eop_core<eop_exp10>             , public eop_use_mp_false {};
class eop_trunc_exp         : public eop_core<eop_trunc_exp>         , public eop_use_mp_false {};
class eop_cos               : public eop_core<eop_cos>               , public eop_use_mp_false {};
class eop_sin               : public eop_core<eop_sin>               , public eop_use_mp_true  {};  // enabled for testing purposes
class eop_tan               : public eop_core<eop_tan>               , public eop_use_mp_false {};
class eop_acos              : public eop_core<eop_acos>              , public eop_use_mp_false {};
class eop_asin              : public eop_core<eop_asin>              , public eop_use_mp_false {};
class eop_atan              : public eop_core<eop_atan>              , public eop_use_mp_false {};
class eop_cosh              : public eop_core<eop_cosh>              , public eop_use_mp_false {};
class eop_sinh              : public eop_core<eop_sinh>              , public eop_use_mp_false {};
class eop_tanh              : public eop_core<eop_tanh>              , public eop_use_mp_false {};
class eop_acosh             : public eop_core<eop_acosh>             , public eop_use_mp_false {};
class eop_asinh             : public eop_core<eop_asinh>             , public eop_use_mp_false {};
class eop_atanh             : public eop_core<eop_atanh>             , public eop_use_mp_false {};
class eop_eps               : public eop_core<eop_eps>               , public eop_use_mp_false {};
...
class eop_lgamma            : public eop_core<eop_lgamma>            , public eop_use_mp_false {};
