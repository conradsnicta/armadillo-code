...
eglue_core<eglue_type>::apply(outT& out, const eGlue<T1, T2, eglue_type>& x)
  ...
  if(use_at == false)
    ...
    if(use_mp && mp_len<eT, (Proxy<T1>::use_mp && Proxy<T2>::use_mp)>::test(n_elem))
      {
    ...
    if(use_mp && mp_len<eT, (Proxy<T1>::use_mp && Proxy<T2>::use_mp)>::test(x.get_n_elem()))
      {
...
eglue_core<eglue_type>::apply(Cube<typename T1::elem_type>& out, const eGlueCube<T1, T2, eglue_type>& x)
  ...
  if(use_at == false)
    ...
    if(use_mp && mp_len<eT, (ProxyCube<T1>::use_mp && ProxyCube<T2>::use_mp)>::test(n_elem))
      {
    ...
    if(use_mp && mp_len<eT, (ProxyCube<T1>::use_mp && ProxyCube<T2>::use_mp)>::test(x.get_n_elem_slice()))
      {
